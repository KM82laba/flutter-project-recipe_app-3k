// ignore_for_file: use_super_parameters, prefer_const_constructors_in_immutables, prefer_final_fields, prefer_interpolation_to_compose_strings
...
class ListFavCardsRecipe extends StatefulWidget {
  ListFavCardsRecipe({Key? key}) : super(key: key);

  @override
  State<ListFavCardsRecipe> createState() => _ListCardsRecipeState();
}

class _ListCardsRecipeState extends State<ListFavCardsRecipe> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<RecipeCardInfo>>(
      future: _databaseHelper.getAllUserFavoriteRecipes(),
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return GridView.builder(
            ...
            itemBuilder: (context, index) {
              RecipeCardInfo recipe = recipes[index];
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  IconButton.filled(
                                    onPressed: () async {
                                      await _databaseHelper.updateFavoriteStatus(recipe.recipe_id!, !recipe.is_favorite);
                                      setState(() {
                                        recipe.is_favorite =!recipe.is_favorite;
                                      });
                                    },
                                    icon: Icon(recipe.is_favorite ? SolarIconsBold.bookmark : SolarIconsOutline.bookmark),
                                    iconSize: 18,
...
class RecipeDetailPage extends StatefulWidget {
  ...
  RecipeDetailPage({Key? key, required this.reciep}) : super(key: key);
